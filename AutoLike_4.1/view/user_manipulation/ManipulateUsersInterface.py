...
from view.user_manipulation.ManipulateUsersFragments import MinimumWidgets
...
class SelectUsers:
    ...
    def readReturn(self, **kws):
        ...
        " this method just read the return of 'MinimumWidgets.py' "
    ...
    def startInterface(self, **kws):
        ...
        fragments = MinimumWidgets(window)
        ...
        window.protocol("WM_DELETE_WINDOW", self.__on_close)
