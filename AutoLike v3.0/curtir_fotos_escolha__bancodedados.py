...
class CurtirFotosEscolhaBancoDeDados():
    ...
    def curtir_fotos(self, janela, quant_curtidas_usuarios):

        if quant_curtidas_usuarios.isalpha == True:
    ...
    def __init__(self, email_curto, status, n_usuarios):
        ...
        bg='dark salmon',
        activebackground='salmon', activeforeground='white',
        command=lambda: self.curtir_fotos(janela, e_quant_curtidas.get()))
